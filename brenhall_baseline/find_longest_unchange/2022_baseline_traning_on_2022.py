...
LOAD_DATA       = path.join(EXAMPLES_DIR, "data",  "load_after_processing_2022.csv")
TEMP_DATA       = path.join(EXAMPLES_DIR, "data",  "temp_after_processing_2022.csv")
TEMP_FORECAST   = path.join(EXAMPLES_DIR, "data",  "temp_after_processing_2023.csv")
TARIFF          = path.join(EXAMPLES_DIR, "data",  "tariff.json")

BASELINE_NAME   = "2022 Baseline Traning"
...
file_name = path.join(EXAMPLES_DIR, "output", "baseline_training_on_2022-prediction_on_2023.json")
