...
file_path_temp = './brenhall_baseline/find_longest_unchange/data/skyspark_raw_data/pre_temp_2022.csv'
...
file_path_interpolated = './brenhall_baseline/find_longest_unchange/data/interpolated_load_2022_cleaned.csv'
...
output_path_temp_unix = './brenhall_baseline/find_longest_unchange/data/aligned_temp_2022_unix.csv'
